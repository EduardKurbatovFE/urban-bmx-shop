...
const Header = () => {
  ...
  return (
    <div className="flex justify-center items-center bg-stone-900 min-h-40 py-4 md:max-2xl:p-6 max-md:p-6  max-md:min-h-min">
          ...
          <div className="flex gap-4 max-[200px]:flex-col">
            ...
            >
              <span className="group-hover:opacity-80">
                {user ? (
                  <div
                    className={`w-6 h-6 overflow-hidden rounded-full ${user.avatar_url ? 'block' : 'hidden'}`}
                  >
                    <img
